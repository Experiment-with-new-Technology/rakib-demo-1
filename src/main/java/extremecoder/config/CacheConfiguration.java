...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, extremecoder.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, extremecoder.repository.UserRepository.USERS_BY_EMAIL_CACHE);
