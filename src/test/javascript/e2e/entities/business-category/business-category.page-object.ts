...
export class BusinessCategoryComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-business-category div table .btn-danger'));
  title = element.all(by.css('jhi-business-category div h2#page-heading span')).first();
...
export class BusinessCategoryUpdatePage {
  pageTitle = element(by.id('jhi-business-category-heading'));
...
export class BusinessCategoryDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-businessCategory-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-businessCategory'));
